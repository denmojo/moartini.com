...
<div class="style4">
  <p><h1>Is it MARTINI TIME YET?</h1></p>
</div>
<div class="style4">
  ...
  <table border="0" bgcolor="#00611C">
	<tr>
		...
		case 3:
		case 4: ?>
		<td align="center"><script type="text/javascript">countdown_clock(<?php echo $nextFridayYear ?>, <?php echo $nextFridayMonth ?>, <?php echo $nextFridayDate ?>, 16, 00, 1);</script></td>
		<?php break;
		case 5: ?>
		<td align="center"><script type="text/javascript">countdown_clock(<?php echo $nextFridayYear ?>, <?php echo $todayFridayMonth ?>, <?php echo $todayFridayDate ?>, 16, 00, 1);</script></td>
		<?php break;
		case 6:
		case 7: ?>
